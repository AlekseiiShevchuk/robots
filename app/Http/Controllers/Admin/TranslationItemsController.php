...
use App\Http\Requests\Admin\StoreTranslationItemsRequest;
use App\Http\Requests\Admin\UpdateTranslationItemsRequest;
use App\Language;
...
class TranslationItemsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.translation_items.index', compact('translation_items', 'languages'));
    }
    ...
    public function massUpdate(Request $request)
    {
        ...
        return redirect()->route('admin.translation_items.index');
    }
    ...
    public function create()
    {
        ...
        $languages = Language::where('is_active_for_admin', 1)->get();
        return view('admin.translation_items.create', compact('languages'));
    }

    /**
     * Store a newly created TranslationItem in storage.
     *
     * @param  \App\Http\Requests\Admin\StoreTranslationItemsRequest $request
     * @return \Illuminate\Http\Response
     */
    ...
    public function edit($id)
    {
        ...
        return view('admin.translation_items.edit', compact('translation_item', 'languages'));
    }

    /**
     * Update TranslationItem in storage.
     *
     * @param  \App\Http\Requests\Admin\UpdateTranslationItemsRequest $request
     * @param  int $id
     * @return \Illuminate\Http\Response
     */
    ...
    public function show($id)
    {
        ...
        return view('admin.translation_items.show', compact('translation_item'));
    }
    ...
    public function exportExcel($type)
    {
        ...
        return Excel::create(env('APP_NAME') . '_translations', function ($excel) use ($data) {
